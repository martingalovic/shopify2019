...
class Api::V1::CartsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "carts controller show should return unassigned cart contents to guest" do
    get api_v1_carts_show_url, params: { cart_token: guest_cart.token }
    assert_response :success
  end

  test "carts controller show should not return assigned cart contents to guest" do
    get api_v1_carts_show_url, params: { cart_token: user_cart.token }
    assert_response 401
  end

  test "carts controller complete should complete unassigned uncompleted cart for guest" do
    post api_v1_carts_complete_url, params: { cart_token: guest_cart.token }
    assert_response :success
  end
  ...
  test "carts controller complete should not complete assigned uncompleted cart for guest" do
    post api_v1_carts_complete_url, params: { cart_token: user_cart.token }
    assert_response 401
  end
  ...
  test "carts controller complete should destroy unassigned uncompleted cart for guest" do
    delete api_v1_carts_destroy_url, params: { cart_token: guest_cart.token }
    assert_response :success
  end
  ...
  test "carts controller complete should not destroy assigned uncompleted cart for guest" do
    delete api_v1_carts_destroy_url, params: { cart_token: user_cart.token }
    assert_response 401
  end
  ...
  test "carts controller show should return assigned cart contents to logged in user" do
    get api_v1_carts_show_url, params: { cart_token: user_cart.token }, headers: authenticated_header
    assert_response :success
  end

  test "carts controller show should return unassigned cart contents to logged in user" do
    get api_v1_carts_show_url, params: { cart_token: guest_cart.token }, headers: authenticated_header
    assert_response :success
  end

  test "carts controller show should not return assigned cart contents to wrong user" do
    get api_v1_carts_show_url, params: { cart_token: user_cart.token }, headers: authenticated_header(:two)
    assert_response 401
  end

  test "carts controller complete should complete assigned uncompleted cart for logged in user" do
    post api_v1_carts_complete_url, params: { cart_token: user_cart.token }, headers: authenticated_header
    assert_response :success
  end
  ...
  test "carts controller complete should not complete assigned uncompleted cart to wrong user" do
    post api_v1_carts_complete_url, params: { cart_token: user_cart.token }, headers: authenticated_header(:two)
    assert_response 401
  end

  test "carts controller complete should not complete assigned completed cart to wrong user" do
  ...
  test "carts controller complete should destroy assigned uncompleted cart for logged in user" do
    delete api_v1_carts_destroy_url, params: { cart_token: user_cart.token }, headers: authenticated_header
    assert_response :success
  end
